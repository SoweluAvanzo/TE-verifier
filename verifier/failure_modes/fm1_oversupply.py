...
from schema import Token, TokenEconomy, TokenFunction
from verifier.asymptotic import representative_midpoint, rule_rate_per_period
...
class FM1Oversupply(FailureMode):
    ...
    def _check_token(self, te: TokenEconomy, token: Token) -> Verdict:
        ...
        # reputation marker with no growth), oversupply cannot occur from
        # emission alone.
        ...
        # frequency for behavior-triggered rules).
